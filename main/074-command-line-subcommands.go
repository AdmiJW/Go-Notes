...
func CommandLineSubcommands() {
	...
	// To run this program with `foo` subcommand
	//     go run ./main foo -enable -name=joe a1 a2
	// Now try `bar` subcommand
	//	 go run ./main bar -level 8 a1
	// But bar won't work with foo flags
	//	 go run ./main bar -enable a1
}