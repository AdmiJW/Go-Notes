...
// Here, pointers are demonstrated with 2 functions: `zeroval` and `zeroptr`.
// `zeroval` has an `int` parameter, so arguments will be passed to it by value.
// `zeroval` will get a copy of `ival` distinct from the one in the calling function.
func zeroval(ival int) {
	if ival == 1 { fmt.Print(ival) }	// To prevent the compiler from complaining about overwriting the value of `ival` 
	ival = 0
}
