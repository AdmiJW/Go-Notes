...
// We do this when we need an external processes accessible to a running Go process.
...
func ExecingProcesses() {
	...
	// Go does not offer a classic Unix `fork` function. Usually this isn't an issue though, since starting goroutines,
