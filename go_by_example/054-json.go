...
// Go offers built-in support for JSON encoding and decoding with the `encoding/json` package.

func JSON() {
	// We'll use these two structs to deomonstrate encoding and decoding of custom types.
	// Only exported fields will be encoded/decoded in JSON.
	// Fields must start with an uppercase letter to be exported.
	...
	// And here for some for slices and maps, which encode to JSON arrays and objects as you'd expect.
	...
	// All of this can be done in a single step with a custom data structure.
	// This has the advantage of adding additional type-safety to our programs and eliminating 
	...
	// In the examples above we always used bytes and strings as intermediates between data and JSON representation on standard out.
