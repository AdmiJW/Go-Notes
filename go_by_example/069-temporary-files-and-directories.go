...
func TemporaryFilesAndDirectories() {
	...
	// Display the name of the temporary file. On Unix-based OSes, the directory will be `/tmp`.
	...
	// Now we can synthesize temporary file names by prefixing them with the temporary directory.
