...
func Timeouts() {
	...
	// Note that the channel is buffered (with a capacity of 1), so the send in the goroutine is non-blocking.
	...
	// If we allow a longer timeout of 3s, the receive from `c2` will succeed and we'll print the result.
