...
// Go offers built-in support for regular expressions with the `regexp` package.
...
func RegularExpressions() {
	...
	// When creating global variables with regular expressions, you can use the `MustCompile` variant of `Compile`.
